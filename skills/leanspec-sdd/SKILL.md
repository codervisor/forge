...
name: leanspec-sdd
description: >
  Spec-Driven Development methodology for AI-assisted development. Use when working
  with specs, planning features, multi-step changes, task breakdowns, design decisions,
  or any task involving a specs/ folder or .lean-spec/config.json.
...
- `$PROJECT_ROOT/.github/skills/leanspec-sdd/`
- `$PROJECT_ROOT/skills/leanspec-sdd/`
