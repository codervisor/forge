...
- **Populate all known fields at creation time** — pass title, content, priority, tags directly to `create`.
...
- Creating empty specs then updating — populate content at creation time.
